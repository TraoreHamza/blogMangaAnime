 ...
 */
final class Version20250826150055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , status VARCHAR(50) DEFAULT NULL, CONSTRAINT FK_794381C6A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_794381C6ED239CA FOREIGN KEY (manga_anime_id) REFERENCES manga_anime (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , status VARCHAR(50) DEFAULT NULL, CONSTRAINT FK_794381C6A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_794381C69CCE44B2 FOREIGN KEY (manga_animes_id) REFERENCES manga_anime (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
